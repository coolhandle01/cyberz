"""
models.asset.graph - the bundled ``AttackGraph`` the OSINT Analyst emits.

Everything the OA found about a programme's attack surface, composed from the
per-asset shapes in the sibling modules. The top of the asset dependency
order: it imports the endpoint / host / ip / certificate shapes, nothing
imports it.
"""
...
from models.asset.endpoint import Endpoint
from models.asset.host import HostInsight
